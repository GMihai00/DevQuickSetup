...
impl ExecutorFactory {
    ...
    {
        match name {
            "exec" => { return Box::new(ExecCommandExecutor{}); },
            "winget" => { return  Box::new(WingetCommandExecutor{}); },
            "include" => { return Box::new(IncludeCommandExecutor{}); },
            ...
            _ => { panic!("Failed to create command corresponding to name: {}", name)}
        }
    }
}